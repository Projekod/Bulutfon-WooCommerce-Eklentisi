...
<div class="wrap">
    <h2 class="nav-tab-wrapper">
        <a href="<?=menu_page_url( 'Bulutfon-WooCommerce-Eklentisi/admin.php', false ); ?>&tab=general" class="nav-tab <?=$activeTab['general']; ?>">Bilgilendirme</a>
        <a href="<?=menu_page_url( 'Bulutfon-WooCommerce-Eklentisi/admin.php', false ); ?>&tab=template_setting" class="nav-tab <?=$activeTab['template_setting']; ?>">Template Ayarları</a>
        <a href="<?=menu_page_url( 'Bulutfon-WooCommerce-Eklentisi/admin.php', false ); ?>&tab=sms_queue" class="nav-tab <?=$activeTab['sms_queue']; ?>">Sms Kuyruğu</a>
