...
<div style="margin:20px;margin-top:5px; text-align: center">
    <fieldset class="text-center">
        <h1>Bulutfon</h1>
        <img src="<?=plugins_url('Bulutfon-WooCommerce-Eklentisi/images');?>/bulutfonlogo.png" alt="bulutfon logo"/>
        ...
        <p>
            Bu eklenti ile kullandığınız Wordpress-Woocommerce eklentisi üzerinden bulutfon özelliklerini yönetebilir ve raporlama yapabilirsiniz.
        </p>
    </fieldset>
    <div class="ara" style="display: block;height: 45px;"></div>
    <fieldset class="text-center">
        <h1>Projekod Yazılım</h1>
        <img src="<?=plugins_url('Bulutfon-WooCommerce-Eklentisi/images');?>/projekodlogo.png"  alt="projekod logo" />
        <p>
